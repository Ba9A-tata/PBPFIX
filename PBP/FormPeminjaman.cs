...
namespace PBP
{
    public partial class FormPeminjaman : Form
    {
        ...
        private void txtIDPeminjaman_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
                MessageBox.Show("ID Peminjaman hanya boleh angka.", "Validasi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }

        private void txtIDAnggota_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
                MessageBox.Show("ID Anggota hanya boleh angka.", "Validasi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }

        }

        private void txtIDBuku_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
                MessageBox.Show("ID Buku hanya boleh angka.", "Validasi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
    }
}